<div>
    ...
    <div wire:loading.block wire:target="submit" class="w-full">
        <div class="flex flex-col justify-center items-center">
            <div>
                <img src="/images/seguro.png" alt="Procesando pago" class="mt-4 h-52">
            </div>
            <div class="flex flex-row justify-center items-center mt-12">
                ...
                <span class="font-bold">Conectando con pasarela de pago</span>
            </div>
        </div>
    </div>
